...
`;
 ...
 function applyHeroImage(){var img=document.querySelector('.home-photo img');if(img){img.src='/v3/Gang%20COEP%20Header.jpg';img.removeAttribute('srcset');img.setAttribute('data-exact-home-photo','Gang COEP Header.jpg');}}
 var n=0,t=setInterval(function(){applyHeroImage();if(++n>120)clearInterval(t);},250);applyHeroImage();
};
