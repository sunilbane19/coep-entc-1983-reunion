(function(){
  ...
  function polishAdminLayout(d){
    ...
    if(!d.getElementById('v3AdminLayoutStyle')){var st=d.createElement('style');st.id='v3AdminLayoutStyle';st.textContent='.v3-admin-head{display:flex!important;flex-direction:column!important;align-items:stretch!important;gap:10px!important}.v3-admin-description{white-space:nowrap!important;margin:0!important;overflow:hidden!important;text-overflow:ellipsis!important}.v3-admin-head-actions{display:flex!important;flex-direction:row!important;flex-wrap:nowrap!important;gap:8px!important;margin-top:0!important}.v3-admin-head-actions .btn{flex:1 1 0!important;white-space:nowrap!important}.v3-admin-head-actions .btn{padding:10px 13px!important}@media(max-width:700px){.v3-admin-description{font-size:14px!important}.v3-admin-head-actions{gap:5px!important}.v3-admin-head-actions .btn{padding:9px 4px!important;font-size:10px!important}}';d.head.appendChild(st);}
  }
